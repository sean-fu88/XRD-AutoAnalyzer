...
def train_model(x_train, y_train, n_phases, num_epochs, n_dense=[3100, 1200], dropout_rate=0.7, is_pdf = False):
    """
    Args:
...
def main(xrd, num_epochs, testing_fraction, fmodel='Model.h5', is_pdf=False):
